...
class AtendimentoController:
    ...
    def registrar_atendimento(self, paciente_id, observacoes, tem_exames, tipo_exame=None, paciente_atendido=False):
        ...
        if paciente_atendido:
            self.fila_service.remover_paciente_da_fila_atendimento(paciente)
