...
from sistemadegestaodepacientes.repository.fila_exames_repository import FilaExamesRepository
...
class FilaService:
    def __init__(self):
        ...
        self.fila_exames_repository = FilaExamesRepository()  # 💡 Correção: adicionada aqui!
    ...
    def get_proximo_paciente_atendimento(self):
        ...
        def prioridade(paciente):
            ...
            idade_valor = 0 if paciente.idade >= 60 or paciente.idade <= 5 else 1
    ...
    def remover_paciente_da_fila_atendimento(self, paciente):
        ...
        if not sucesso:
            raise ValueError("Paciente não está na fila de atendimento.")
        return sucesso 
